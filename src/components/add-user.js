            ...
            <div className="container-fluid">
                <div className="row form-group">
                    <div className="col-md-3">
                        ...
                        <input type="text" className="form-control" placeholder="Full Name" name="fullName" onChange={this.handleChange} value={this.state.currentUser.fullName} />
                        <p className="text-danger">{this.state.hasErrors ? this.state.errors.fullName : ''}</p>
                    </div>
                    <div className="col-md-3">
                        <label for="dob">Date of Birth</label>
                        <input type="number" className="form-control" placeholder="Date of Birth" name="dob" onChange={this.handleChange} value={this.state.currentUser.dob} />
                        <p className="text-danger">{this.state.hasErrors ? this.state.errors.dob : ''}</p>
                    </div>
                    <div className="col-md-3">
                        <label for="location">Location</label>
                        <input type="text" className="form-control" placeholder="Location" name="location" onChange={this.handleChange} value={this.state.currentUser.location} />
                        <p className="text-danger">{this.state.hasErrors ? this.state.errors.location : ''}</p>
                    </div>
                    <div className="col-md-3">
                        <label for="location">Occupation</label>
                        <input type="text" className="form-control" placeholder="Occupation" name="occupation" onChange={this.handleChange} value={this.state.currentUser.occupation} />
                ...
                <div className="row form-group">
                    <div className="col-md-3">
                        ...
                        <input type="number" className="form-control" placeholder="Phone Number" name="phoneNumber" onChange={this.handleChange} value={this.state.currentUser.phoneNumber} />
                        <p className="text-danger">{this.state.hasErrors ? this.state.errors.phoneNumber : ''}</p>
                    </div>
                    <div className="col-md-3 form-group">
                        <label for="email">Email</label>
                        <input type="email" className="form-control" placeholder="Email" name="email" onChange={this.handleChange} value={this.state.currentUser.email} />
                        <p className="text-danger">{this.state.hasErrors ? this.state.errors.email : ''}</p>
                    </div>
                    <div className="col-md-3">
                        <label for="sex">Sex</label>
                        <select className="form-control" name="sex" onChange={this.handleChange} value={this.state.currentUser.sex}>
                ...
                <div className="row form-group">
                    <div className="col-md-3">
                        ...
                        <input type="text" className="form-control" placeholder="www.facebook.com/johndoe" name="fbUrl" onChange={this.handleChange} value={this.state.currentUser.fbUrl} />
                        <p className="text-danger">{this.state.hasErrors ? this.state.errors.fbUrl : ''}</p>
                    </div>
                    <div className="col-md-3">
                        <label for="twitterUrl">Twitter Profile</label>
                        <input type="text" className="form-control" placeholder="www.twitter.com/johndoe" name="twitterUrl" onChange={this.handleChange} value={this.state.currentUser.twitterUrl} />
                        <p className="text-danger">{this.state.hasErrors ? this.state.errors.twitterUrl : ''}</p>

                    </div>
                    <div className="col-md-3">
                        <label for="linkedinUrl">Linkedin Profile</label>
                        <input type="text" className="form-control" placeholder="www.linkedin.com/johndoe" name="linkedinUrl" onChange={this.handleChange} value={this.state.currentUser.linkedinUrl} />
                ...
                <div className="row">
                    <div className="col-md-2 offset-md-8">
                        <button onClick={this.handleSubmit} className="btn btn-success btn-block">
                            SAVE
                        </button>
                    </div>
